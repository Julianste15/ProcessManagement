...
public class EvaluationController {
    ...
    public ResponseEntity<?> createEvaluation(@Valid @RequestBody CreateEvaluationRequest request,
        ...
        try {
            ...
            // Solo coordinadores y administradores pueden crear evaluaciones
    ...
    public ResponseEntity<?> submitEvaluation(@PathVariable Long evaluationId,
        ...
        try {
            ...
            // Verificar que el usuario sea el evaluador asignado
    ...
    public ResponseEntity<?> getEvaluationsByProject(@PathVariable Long projectId,
                                                   HttpServletRequest httpRequest) {
        try {
            String userRole = httpRequest.getHeader("X-User-Role");
            
            // Solo usuarios autorizados pueden ver las evaluaciones
    ...
    private boolean isAssignedEvaluator(Long evaluationId, String userEmail) {
        // Implementar lógica para verificar si el usuario es el evaluador asignado
