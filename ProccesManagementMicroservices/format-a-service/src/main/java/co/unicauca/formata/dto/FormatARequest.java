...
public class FormatARequest {
    ...
    public String getCartaAceptacionEmpresaNombre() {return cartaAceptacionEmpresaNombre;}
    public void setCartaAceptacionEmpresaNombre(String cartaAceptacionEmpresaNombre) {this.cartaAceptacionEmpresaNombre = cartaAceptacionEmpresaNombre;}
}