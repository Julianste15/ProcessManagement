...
public class MicroserviceClient {
    ...
    public void setToken(String token) {this.currentToken = token;}
    public String getToken() {return currentToken;}
    public void clearToken() {this.currentToken = null;}
    ...
    private <T> T handleResponse(HttpURLConnection connection, Class<T> responseType) throws Exception {
        ...
        if (inputStream == null) {
            String errorMsg = "No hay respuesta del servidor. Código: " + responseCode +
