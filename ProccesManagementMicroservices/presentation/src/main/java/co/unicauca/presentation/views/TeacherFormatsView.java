...
/**
 * Vista para que los docentes vean sus formatos A y puedan reenviar los
 * rechazados
 * Diseño Moderno
 */
public class TeacherFormatsView {
    ...
    private void initUI() {
        ...
        // // Optional: Controller might set this
    ...
    private TableView<FormatRow> buildFormatsTable() {
        ...
        statusCol.setCellFactory(column -> new TableCell<FormatRow, String>() {
            ...
            protected void updateItem(String item, boolean empty) {
                ...
                if (empty || item == null) {
                    ...
                    badge.getStyleClass().add("status-badge"); // Keep existing badge style or adapt
                    ...
                    if (item.contains("RECHAZADO")) {
                        ...
                        badge.setStyle(
                                "-fx-background-color: #fef3c7; -fx-text-fill: #92400e; -fx-padding: 4 8; -fx-background-radius: 12;");
                    }
                    setGraphic(badge);
                    setText(null);
                }
        ...
        actionsCol.setCellFactory(param -> new TableCell<FormatRow, Void>() {
            ...
            {
                reenviarBtn.getStyleClass().add("primary-button"); // Use new style
                reenviarBtn.setStyle("-fx-font-size: 11px; -fx-padding: 4 10;"); // Adjust for table
...
=======
>>>>>>> 2ce1592 (feat: Mejorar estilos del dashboard del profesor con CSS personalizado)
    ...
    // Adapted to match controller calls but using new UI elements
    public void showStatus(String message, boolean isError) {
        statusLabel.setText(message);
        // We update the badge count if possible, but the message might be generic
        // The controller calls this with "Formatos cargados: X"
     ...
     * MANTENIDA EXACTAMENTE IGUAL para compatibilidad con el controlador
     */
